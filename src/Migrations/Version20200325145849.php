 ...
 */
final class Version20200325145849 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        //$this->addSql('ALTER TABLE doses CHANGE unit unit VARCHAR(10) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        //$this->addSql('ALTER TABLE doses CHANGE unit unit VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
