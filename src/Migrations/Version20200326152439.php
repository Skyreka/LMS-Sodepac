 ...
 */
final class Version20200326152439 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE doses (id INT AUTO_INCREMENT NOT NULL, product_id INT NOT NULL, dose DOUBLE PRECISION DEFAULT NULL, application VARCHAR(255) NOT NULL, unit VARCHAR(10) DEFAULT NULL, INDEX IDX_4EE4A8A84584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
