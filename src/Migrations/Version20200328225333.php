 ...
 */
final class Version20200328225333 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recommendation_products (id INT AUTO_INCREMENT NOT NULL, recommendation_id INT NOT NULL, product_id INT NOT NULL, INDEX IDX_6C87D690D173940B (recommendation_id), INDEX IDX_6C87D6904584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
