 ...
 */
final class Version20220321143404 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE panorama_user (id INT AUTO_INCREMENT NOT NULL, customers_id INT NOT NULL, panorama_id INT NOT NULL, sender_id INT NOT NULL, display_at DATETIME DEFAULT NULL, checked TINYINT(1) NOT NULL, INDEX IDX_D9701341F58D4635 (panorama_id), INDEX IDX_D9701341C3568B40 (customers_id), INDEX IDX_D9701341F624B39D (sender_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE panoramas (id INT AUTO_INCREMENT NOT NULL, owner_id INT DEFAULT NULL, text LONGTEXT CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, first_file VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, second_file VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, third_file VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, validate TINYINT(1) NOT NULL, sent TINYINT(1) NOT NULL, creation_date DATETIME NOT NULL, send_date DATETIME DEFAULT NULL, archive TINYINT(1) NOT NULL, INDEX IDX_DDADFCB37E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE panoramas ADD CONSTRAINT FK_DDADFCB37E3C61F9 FOREIGN KEY (owner_id) REFERENCES users (id)');
