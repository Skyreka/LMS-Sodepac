 ...
 */
final class Version20220302123831 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cultures ADD added_at DATETIME DEFAULT NULL, ADD update_at DATETIME DEFAULT NULL, ADD is_active TINYINT(1) DEFAULT NULL');
        $this->addSql('ALTER TABLE ilots ADD added_at DATETIME DEFAULT NULL, ADD update_at DATETIME DEFAULT NULL, ADD is_active TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cultures DROP added_at, DROP update_at, DROP is_active, CHANGE comments comments VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE ilots DROP added_at, DROP update_at, DROP is_active, CHANGE name name VARCHAR(50) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE panoramas CHANGE text text LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE first_file first_file VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE second_file second_file VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE third_file third_file VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
