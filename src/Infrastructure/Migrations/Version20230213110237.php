 ...
 */
final class Version20230213110237 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ads (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(30) NOT NULL, description VARCHAR(120) DEFAULT NULL, status INT NOT NULL, added_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', update_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_active TINYINT(1) DEFAULT NULL, filename VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE canevas_disease (id INT AUTO_INCREMENT NOT NULL, canevas_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, sort INT DEFAULT NULL, INDEX IDX_2E6BD3EF170E3058 (canevas_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE canevas_index (id INT AUTO_INCREMENT NOT NULL, slug VARCHAR(50) NOT NULL, name VARCHAR(50) NOT NULL, is_active TINYINT(1) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE canevas_step (id INT AUTO_INCREMENT NOT NULL, canevas_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, img VARCHAR(255) DEFAULT NULL, sort INT DEFAULT NULL, INDEX IDX_7E6F1854170E3058 (canevas_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE catalogue (id INT AUTO_INCREMENT NOT NULL, customer_id INT NOT NULL, canevas_id INT NOT NULL, create_by_id INT NOT NULL, status INT NOT NULL, mention LONGTEXT DEFAULT NULL, culture_size DOUBLE PRECISION NOT NULL, added_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', update_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', is_active TINYINT(1) NOT NULL, comment VARCHAR(255) DEFAULT NULL, INDEX IDX_59A699F59395C3F3 (customer_id), INDEX IDX_59A699F5170E3058 (canevas_id), INDEX IDX_59A699F59E085865 (create_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, creator_id INT NOT NULL, customer_id INT NOT NULL, signature_id INT DEFAULT NULL, id_number VARCHAR(150) NOT NULL, create_date DATETIME NOT NULL, status INT NOT NULL, delivery LONGTEXT DEFAULT NULL, conditions LONGTEXT DEFAULT NULL, added_at DATETIME DEFAULT NULL, update_at DATETIME DEFAULT NULL, is_active TINYINT(1) DEFAULT NULL, INDEX IDX_E52FFDEE61220EA6 (creator_id), INDEX IDX_E52FFDEE9395C3F3 (customer_id), UNIQUE INDEX UNIQ_E52FFDEEED61183A (signature_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE products (id INT AUTO_INCREMENT NOT NULL, category_id INT DEFAULT NULL, parent_product_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, private TINYINT(1) NOT NULL, id_lex VARCHAR(255) DEFAULT NULL, amm VARCHAR(255) DEFAULT NULL, substance VARCHAR(255) DEFAULT NULL, tox VARCHAR(255) DEFAULT NULL, risk_phase VARCHAR(255) DEFAULT NULL, bio TINYINT(1) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, dar VARCHAR(255) DEFAULT NULL, znt VARCHAR(255) DEFAULT NULL, dre VARCHAR(255) DEFAULT NULL, security_mention VARCHAR(255) DEFAULT NULL, danger_mention VARCHAR(255) DEFAULT NULL, warning_mention VARCHAR(255) DEFAULT NULL, rpd DOUBLE PRECISION DEFAULT NULL, n DOUBLE PRECISION DEFAULT NULL, p DOUBLE PRECISION DEFAULT NULL, k DOUBLE PRECISION DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, is_active TINYINT(1) DEFAULT NULL, INDEX IDX_B3BA5A5A12469DE2 (category_id), INDEX IDX_B3BA5A5A2C7E20A (parent_product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE canevas_disease ADD CONSTRAINT FK_2E6BD3EF170E3058 FOREIGN KEY (canevas_id) REFERENCES canevas_index (id)');
        $this->addSql('ALTER TABLE canevas_step ADD CONSTRAINT FK_7E6F1854170E3058 FOREIGN KEY (canevas_id) REFERENCES canevas_index (id)');
        $this->addSql('ALTER TABLE catalogue ADD CONSTRAINT FK_59A699F59395C3F3 FOREIGN KEY (customer_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE catalogue ADD CONSTRAINT FK_59A699F5170E3058 FOREIGN KEY (canevas_id) REFERENCES canevas_index (id)');
        $this->addSql('ALTER TABLE catalogue ADD CONSTRAINT FK_59A699F59E085865 FOREIGN KEY (create_by_id) REFERENCES users (id)');
        ...
        $this->addSql('ALTER TABLE recommendations ADD CONSTRAINT FK_73904ED7B108249D FOREIGN KEY (culture_id) REFERENCES canevas_index (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE canevas_disease DROP FOREIGN KEY FK_2E6BD3EF170E3058');
        $this->addSql('ALTER TABLE canevas_step DROP FOREIGN KEY FK_7E6F1854170E3058');
        $this->addSql('ALTER TABLE catalogue DROP FOREIGN KEY FK_59A699F59395C3F3');
        $this->addSql('ALTER TABLE catalogue DROP FOREIGN KEY FK_59A699F5170E3058');
        $this->addSql('ALTER TABLE catalogue DROP FOREIGN KEY FK_59A699F59E085865');
        ...
        $this->addSql('DROP TABLE canevas_disease');
        $this->addSql('DROP TABLE canevas_index');
        $this->addSql('DROP TABLE canevas_step');
