 ...
 */
final class Version20220324093916 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders ADD added_at DATETIME DEFAULT NULL, ADD update_at DATETIME DEFAULT NULL, ADD is_active TINYINT(1) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders DROP added_at, DROP update_at, DROP is_active, CHANGE id_number id_number VARCHAR(150) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE delivery delivery LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE conditions conditions LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
